...
object ScalatePlugin extends Plugin {
  ...
  object scalate {
    ...
    val templateRoots       = SettingKey[Seq[File]]     ("template-roots", "Directorires containing Scalate templates.") in Config
    val precompile          = TaskKey[Seq[File]]        ("precompile", "Precompile Scalate templates.") in Config
